...
//sessionStorage.setItem("yo", JSON.stringify(obj));
//localStorage.setItem("yo", JSON.stringify(obj));

const tiempo = new Date();
//document.cookie = "yo =" + JSON.stringify(obj) + ";expires =" + new Date(tiempo.getTime() + 120000);
